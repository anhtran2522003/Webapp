						...
						<div class="billing-details">
							...
							<div class="form-group">
								<input class="input" type="text" name="name"
									placeholder="Full Name" value="${acc.name}">

							</div>
							<div class="form-group">
								<input class="input" type="email" name="email"
									placeholder="Email" value="${acc.usr}">
							</div>
							<div class="form-group">
								<input class="input" type="text" name="address"
									placeholder="Address" value="${acc.address}">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<input class="input" type="tel" name="phoneNumber"
									placeholder="Telephone" value="${acc.phone}">
							</div>
							<div class="form-group">
								...
								<div class="caption">
									...
									<div class="form-group">
										<input class="input" type="tel" name="tel"
											placeholder="phoneNumber"  value="${acc.phone}">
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-md-5 order-details">
						...
						<div class="order-summary">
							...
							<div class="order-col">
								...
								<div>
									<strong class="order-total">${cart.getAmount()}</strong>
								</div>
							</div>
						</div>
