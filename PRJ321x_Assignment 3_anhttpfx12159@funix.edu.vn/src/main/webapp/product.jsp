					...
					<div class="product-details">
						...
						<form action="AddToCart" method="get">
							...
							<div class="product-options">
								<label> Size <select class="input-select" name="size">
										<option value="0">X</option>
										<option value="1">Y</option>
										<option value="2">Z</option>
								</select>
								</label> <label> Color <select class="input-select" name="color">
							...
							<div class="add-to-cart">
								<div class="qty-label">
									...
									<div class="input-number">
										<input type="number" name="quantity" value= "1" > <span
											class="qty-up">+</span> <span class="qty-down">-</span>
									</div>
								</div>

								<button class="add-to-cart-btn" type="submit" name="action"
									value="addToCart">
	...
	<div class="section">
		...
		<div class="container">
			...
			<div class="row">
				...
				<c:forEach var="o" items="${relatedProduct}">
					<!-- product -->
						...
						<div class="product">
							...
							<div class="product-body">
								...
								<h3 class="product-name">
									<a
										href="${pageContext.request.contextPath}/InformationProduct?ProductID=${o.id}">${o.name}</a>
								</h3>
